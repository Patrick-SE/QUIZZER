...
import { useQuiz } from '../../context/QuizContext'; // ✅ Add this back
...
export default function QuizTakingScreen() {
    ...
    const [locked, setLocked] = useState(false); // ✅ Prevent answer changes after selection

    const [userAnswer, setUserAnswer] = useState('');
    const [isCorrect, setIsCorrect] = useState(null); // ✅ Tracks if answer is correct or wrong

    const [allQuestions, setAllQuestions] = useState([]);
    const [currentQuestionIndex, setCurrentQuestionIndex] = useState(0);
    const currentQuestion = allQuestions[currentQuestionIndex] || null;
    
    const [showFullAnswer, setShowFullAnswer] = useState(false); // ✅ Add this state to track when to show the full answer
    ...
    const handleAnswerSelection = (answer) => {
        if (!locked) {
            ...
            setLocked(true); // ✅ Prevents changing the answer after selection
        }
    };
    ...
    const handleCheckAnswer = () => {
        ...
        setIsCorrect(correctEquals || correctContains); // ✅ Runs ONLY when the button is clicked
    
        setShowFullAnswer(!correctEquals && correctContains); // ✅ Show full correct answer if the user answered incorrectly OR partially
    };
            ...
            <>
                ...
                <View style={styles.answersContainer}>
                    ...
                    <TouchableOpacity 
                        ...
                        locked && answer === currentQuestion.correctAnswer ? styles.correctAnswer : null // ✅ Highlight correct answer
                        ]}
                ...
                <View style={styles.trueFalseContainer}>
                    ...
                    style={[
                        ...
                        locked && currentQuestion.correctAnswer === 'True' ? styles.correctAnswer : null // ✅ Show correct answer if user is wrong
                    ]} 
                    ...
                    style={[
                        ...
                        locked && currentQuestion.correctAnswer === 'False' ? styles.correctAnswer : null // ✅ Show correct answer if user is wrong
                    ]} 
...
const styles = StyleSheet.create({
    ...
    highlightText: {
        color: '#DC3545', // ✅ Make the full answer stand out
    },
    answerRow: { 
        flexDirection: 'row', 
        alignItems: 'center', 
    ...
    wrongAnswer: { 
        ...
        borderColor: '#F44336',
    },  // ✅ Turns RED if incorrect
    trueFalseText: { 
        fontSize: 20, 
        fontWeight: 'bold', 
        color: '#333' // ✅ Default color is visible
    },    
